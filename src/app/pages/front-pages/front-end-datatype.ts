  ...
  export const records = [
    {
      id:1,
      title:'2019',
      subtitle:'When we founded Spike'
    },
     {
      id:2,
      title:'300k+',
      subtitle:'Customers on Spike'
    },
     {
      id:3,
      title:'25k+',
      subtitle:'Dashboards built using Spike'
    }
  ];
 ...
 export const followercardsThird: followercards[] = [
  ...
  export const brandLogos = [
    ...
    },
    {
      ...
      name: 'Jikes Sam',
      subtext:
        'I am using the Spike angular admin, and its feature rich, easy to use and saves a ton of time. The Support Team is great.',
    },
     {
      id: 4,
      imgSrc: '/assets/images/profile/user-1.jpg',
