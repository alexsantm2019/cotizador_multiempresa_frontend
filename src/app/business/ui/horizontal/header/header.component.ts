...
import { BrandingComponent } from '../sidebar/vertical/branding.component';
...
export class CustomAppHorizontalHeaderComponent implements OnInit {
  ...
  logout() {
    ...
    try {
      ...
      this.showError(error?.statusText || 'Error al cerrar sesión');
    }
  }
